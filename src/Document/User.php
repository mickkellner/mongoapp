...
/**
 * @MongoDB\Document(db="mongoapp", collection="users", repositoryClass="App\Repository\UserRepository")
 */
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    */
    ...
    public function getProfile(): Profile {return $this->profile ?? new Profile(); }
